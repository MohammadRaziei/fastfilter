...
def parse_json(filename):
    ...
    return [(item["input"], item["output"], item["windowSize"]) for item in data]
...
@pytest.mark.parametrize("kernel", {"median"})
@pytest.mark.parametrize("input_data, expected_output, windowSize", test_data)
